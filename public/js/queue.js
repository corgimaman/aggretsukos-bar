...
queue [
    ...
    30 min until ur song
    4 people ahead of u
]

when user selects song, user and song enter database
date_created =>  query

soft delete: column: exited restaurant, finished performing (boolean)
queue picks everything that has false/null in soft delete column

user.findAll(where song title and where updated_date = date - 4hrs
  if comes back true, error that song was selected, do not insert new data for new wait listed person
  if not true, insert data
